...
| Communes → circonscriptions (trouver son député par sa commune) | `fetch-communes.js` (tous les 90 jours) | résultats des législatives 2022 par commune (même découpage qu'en 2024), ministère de l'Intérieur | `data/communes.json` |
